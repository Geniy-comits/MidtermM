...
Я решил вторую задачу, в которой слил ветки два и три, а потом содержимое появившейся ветки переписал в ветку один - second_task

в задании 5 я создал конфликтный файл в ветке feature, потом решил этот самый конфликт - задания начинающиеся на problem

остальные два фото относятся к 6 заданию, я слил два и три в мэйн, потом удалил их